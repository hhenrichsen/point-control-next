...
const globalForPrisma: { prismaEdge?: PrismaClient } = global as unknown as { prismaEdge?: PrismaClient }

export const prisma: PrismaClient = globalForPrisma.prismaEdge || new PrismaClient()
